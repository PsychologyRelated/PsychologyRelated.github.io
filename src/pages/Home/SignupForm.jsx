                        ...
                        <Form className="form">
                            ...
                            <Flex flexDir={["column", "column", "initial", "initial"]} marginTop={["0", "2rem", "1.5rem", "0"]} paddingX="0.5rem">
                                ...
                                <Flex w="100%" marginTop={["2.5rem", "2.5rem", "0", "0"]} justifyContent={["center", "center", "flex-end", "flex-end"]} display="flex">
                                    <Tooltip placement="bottom-end" bg={colors.azureWhite} border={`1px solid ${colors.sandrift}`} borderRadius="10px" color="#26282adb" label='Get the 7 Step Bigginers Guide to Turning Your Life Around'>
