...
export default function ThankYou({ setIsSubmitted }) {
    ...
    return (
        <Flex textAlign="center" gap="2.5rem" flexDir="column" align="center" paddingTop={["15%", "20%", "10%", "15%"]} justifyContent="center" w={["100%", "90%", "40%", "40%"]}>
            ...
            <Heading fontStyle="oblique" fontWeight={500} fontSize={["20px", "15px", "12px", "17px"]} as="h3">We're thrilled that you're taking this important step towards a happier life! You will be sent our “7-Step Guide to Turning Your Life Around” shortly.</Heading>
            <Flex>
